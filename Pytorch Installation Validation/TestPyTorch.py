...
#Nel caso in cui la prima print restituisce False, allora bisogna eseguire il debug dell'installazione di CUDA, in modo che PyTorch possa rilevare la scheda grafica.
